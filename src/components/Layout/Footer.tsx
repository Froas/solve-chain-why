            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4 font-mono text-sm">
                ...
                <div className="flex items-center space-x-4 text-gray-400 text-sm">
                    ...
                    <a
                        ...
                        className="flex items-center hover:text-green-400 transition"
                    >
                    <svg className="w-5 h-5 mr-1" viewBox="0 0 48 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g><path fill="#38BDF8" d="M14 0C8.6 0 4.5 2.9 2 8.7C4.7 5.8 7.6 4.7 10.6 5.6C12.4 6.1 13.6 7.4 15.1 9.1C17.3 11.5 19.9 14.5 26 14.5C31.4 14.5 35.5 11.6 38 5.8C35.3 8.7 32.4 9.8 29.4 8.9C27.6 8.4 26.4 7.1 24.9 5.4C22.7 3 20.1 0 14 0Z" /><path fill="#38BDF8" d="M34 13.5c-5.4 0-9.5 2.9-12 8.7 2.7-2.9 5.6-4 8.6-3.1 1.8.5 3 1.8 4.5 3.5 2.2 2.4 4.8 5.4 10.9 5.4 5.4 0 9.5-2.9 12-8.7-2.7 2.9-5.6 4-8.6 3.1-1.8-.5-3-1.8-4.5-3.5-2.2-2.4-4.8-5.4-10.9-5.4z" /></g>
                    </svg>
                        Tailwind CSS
                    </a>
                    <a
